<script>
  ...
  let steps = [
    ...
    },
    {
      ...
      icon: 'fa-solid fa-list-check',
      description:
        '•Developed a Node.js backend, cutting order processing time by 30% and handling 200+ transactions/sec. Improved data retrieval speed by 60% with MongoDB, enhancing user experience. Increased user interaction by 45% with Firebase notifications. Enhanced security with WhatsApp authentication, increasing user trust by 65%.',
    ...
    },
    {
      ...
      icon: 'fa-solid fa-list-check',
      description:
        '•Improved the performance of the internal management system, making it faster and more efficient for daily operations, Built an asset management system from scratch to help with auditing and tracking assets, making the whole process more organized and easier to manage.',
  ...
  function scrollToTouchSection() {
    ...
    if (touchSection) {
      ...
      console.error("Element with ID 'touch' not found!"); // Error message if element doesn't exist
    }
  }
  let benefits = [
    {
  ...
  >
    ...
    >
      <h2 class="font-semibold text-4xl sm:text-3xl md:text-5xl">
        ...
        <br />Full Stack
        <h1>
          <span class="poppins text-violet-400 m-0 p-0">Mohammad</span> Abdalrazzak
        </h1>
        <br />Full Stack
      ...
      <p class="text-base sm:text-lg md:text-xl">
        ...
        (Nest.js or Express.js), Node.js & (React or SvelteKit) & MySQL & Prisma!
      </p>
      <button
        id="contact-button"
        class="blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950"
        on:click={scrollToTouchSection}
      >
        <div
    ...
    <div class="relative shadow-2xl place-items-center hidden md:grid">
      <img
  ...
  <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
    <div class="flex flex-col gap-2 text-center">
      ...
      <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">
        Curious to <span class="poppins text-violet-400">see</span> my expertise?
      </h3>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-10">
      <Step step={steps[0]}>
        <p>
          Built a platform for students in Turkey to search for universities and
          educational opportunities. Utilized <strong class="text-violet-400">
            Node.js , MySQL, and Express.js</strong
          > for a dynamic platform with a control panel (180degreesacademy.net).
        </p>
      </Step>
      <Step step={steps[1]}>
        <p>
          Led backend development for hotel management, ensuring real-time
          ...
          increasing data protection by 40%.
        </p>
      </Step>
    </div>
  </section>
